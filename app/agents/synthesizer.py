...
def _build_prompt(
    ...
    voice_cues = (
        ...
        "For budget_estimate: build a trip-total (not per-day) by combining accommodation, food, "
        "local transport, inter-city transport, entry fees (Indian-resident rates, bundled), and "
        "activities — full formula and currency rules in system rule 21.\n"
