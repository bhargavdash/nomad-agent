...
_TZ_OVERRIDES: dict[str, float] = {
    "thailand": 7.0, "bangkok": 7.0, "vietnam": 7.0, "hanoi": 7.0,
    "indonesia": 8.0, "bali": 8.0, "singapore": 8.0, "malaysia": 8.0,
    "japan": 9.0, "tokyo": 9.0, "philippines": 8.0, "sri lanka": 5.5,
    "uk": 0.0, "london": 0.0, "england": 0.0, "scotland": 0.0,
    "france": 1.0, "paris": 1.0, "italy": 1.0, "rome": 1.0, "spain": 1.0,
    "germany": 1.0, "switzerland": 1.0, "greece": 2.0, "portugal": 0.0,
    "new york": -5.0, "nyc": -5.0, "usa": -5.0, "united states": -5.0,
    "los angeles": -8.0, "san francisco": -8.0,
    "australia": 10.0, "sydney": 10.0, "new zealand": 12.0,
}


def _tz_offset_hours(region: str, destination_lower: str) -> float | None:
    if region == "india":
        return 5.5
    for keyword, offset in _TZ_OVERRIDES.items():
...
async def build_geo_brief(
    ...
    try:
        ...
        tz = _tz_offset_hours(signals.region, dest.lower())
